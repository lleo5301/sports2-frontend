...
import { prospectsApi, POSITIONS, SCHOOL_TYPES, PROSPECT_STATUSES } from '@/lib/prospects-api'
...
export function CreateProspectForm() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (prospect) => {
      ...
      navigate({ to: '/prospects/$id', params: { id: String(prospect?.id) } })
    },
    onError: (err) => {
      ...
      <Card className='max-w-2xl'>
        <CardHeader>
          ...
          <p className='text-sm text-muted-foreground'>
            Create a new recruiting prospect
          </p>
        </CardHeader>
        <CardContent>
          <Form {...form}>

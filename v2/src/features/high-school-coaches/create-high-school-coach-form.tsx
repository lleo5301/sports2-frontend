...
export function CreateHighSchoolCoachForm() {
  ...
  return (
    <Main>
      <Card className='max-w-2xl'>
        <CardHeader>
          <CardTitle>Add High School Coach</CardTitle>
          <p className='text-sm text-muted-foreground'>
            Add an HS coach contact
          </p>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            ...
            >
              ...
              <div className='flex gap-2 pt-4'>
                ...
                <Button variant='outline' asChild>
                  <Link to='/high-school-coaches'>Cancel</Link>
                </Button>
              </div>
            </form>
          </Form>

 ...
 *
 * Contains configuration constants for depth chart functionality,
 * including default positions and status color mappings.
 */

/**
 * Default position configurations for baseball depth charts
 * Defines standard baseball positions with their display properties
 * @type {Array<{position_code: string, position_name: string, color: string, icon: string, sort_order: number}>}
 */
...
/**
 * Status color mappings for player status indicators
 * Maps player status types to corresponding Tailwind CSS classes

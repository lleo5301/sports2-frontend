        ...
        {availableThemes.map((theme) => (
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-base-content/60 mt-1 font-medium leading-relaxed">
                {theme.description}
              </p>
            </div>
  ...
  if (isCollapsed) {
    return (
      <div className="relative group/theme flex justify-center py-2">
        <div className="w-10 h-10 rounded-xl bg-base-300/50 flex items-center justify-center text-base-content/60 group-hover/theme:text-base-content group-hover/theme:bg-base-300 transition-all cursor-pointer">
          <Palette className="w-5 h-5" />
        </div>

        {/* Tooltip with theme options */}
        <div className="absolute left-full ml-4 p-2 bg-base-300 rounded-2xl border border-base-content/10 opacity-0 group-hover/theme:opacity-100 pointer-events-none group-hover/theme:pointer-events-auto transition-all duration-300 z-[100] min-w-[200px]">
          <p className="px-3 py-2 text-[10px] uppercase font-black tracking-[0.2em] text-base-content/40 border-b border-ui-border mb-2">
            Select Theme
          </p>
  ...
  return (
    <div className="px-4 py-4 space-y-4">
      <div className="flex items-center justify-between px-2">
        <h3 className="text-[11px] font-bold text-base-content/40 uppercase tracking-[0.25em]">
          Visual System
        </h3>
        <Sparkles className="w-3.5 h-3.5 text-base-content/40" />
      </div>
            ...
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center gap-2.5">
                ...
                <div className="text-left">
                  ...
                  <p className="text-[10px] text-base-content/40 mt-1 leading-none font-medium">
                    {theme.description}
                  </p>
                </div>
              </div>

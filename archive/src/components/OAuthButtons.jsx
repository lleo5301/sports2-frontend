  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        {/* Google OAuth Button */}
        <Button onClick={handleGoogleSignIn} className="flex items-center justify-center gap-2 hover:bg-content1" size="sm" variant="bordered">
        ...
        {/* Apple OAuth Button */}
        <Button onClick={handleAppleSignIn} className="flex items-center justify-center gap-2 hover:bg-content1" size="sm" variant="bordered">

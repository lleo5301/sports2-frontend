  ...
  return (
    <div className="bg-background">
      <Routes>
        ...
        />
        <Route
          path="/reports/create-performance"
          element={
            <ProtectedRoute>
              <Layout>
        ...
        />
        <Route
          path="/reports/create-statistics"
          element={
            <ProtectedRoute>
              <Layout>

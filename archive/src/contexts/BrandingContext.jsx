...
export function BrandingProvider({ children }) {
  ...
  // NOTE: Only sets --team-* variables. DaisyUI vars (--p, --s, etc.) have been
  // removed -- HeroUI v3 handles its own color system via CSS theme variables.
  ...
  const clearBrandingColors = useCallback(() => {
    ...
    const teamVars = [
      ...
      '--team-primary-rgb', '--team-secondary-rgb',
      '--team-heading', '--team-heading-light',
      '--team-accent-bg', '--team-accent-border',
      '--team-glass-bg', '--team-glass-border',
      '--team-gradient-start', '--team-gradient-end',
      '--team-glow', '--team-glow-subtle',
      '--team-focus-ring',
      '--bg-color', '--text-on-bg'
    ];
    teamVars.forEach((v) => root.style.removeProperty(v));
  }, []);

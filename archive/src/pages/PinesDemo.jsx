      ...
      <div className="max-w-6xl mx-auto space-y-8">
          ...
          <CardContent>
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="overview" className="mt-4">
                <p className="text-sm text-muted-foreground">
                  This is the overview tab content. You can put any content
                  here.
                </p>
              </TabsContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Loading placeholders that maintain layout structure
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Simulates paragraph text with multiple lines
              </p>
              <div className="space-y-4">
                <div>
                  <p className="text-sm text-muted-foreground mb-2">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Avatar placeholders in different sizes
              </p>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Card placeholders with header, content, and footer
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Table placeholders with configurable rows and columns
              </p>
            ...
            <div>
                ...
                <TabsContent value="analytics" className="mt-4">
                  <div className="border border-border rounded-lg p-4 bg-card">
                    <p className="text-sm text-muted-foreground mb-4">
                      ...
                      - Flexible skeleton for various page types
                    </p>
                    <div className="max-h-96 overflow-auto">
                      <GenericPageSkeleton
                        contentType="cards"
              ...
              <div className="mt-4 p-4 bg-muted/50 rounded-lg">
                ...
                <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                  <li>
                    <code className="text-xs">DashboardSkeleton</code> -
                    Dashboard page with bento grid
                  </li>
                  <li>
                    <code className="text-xs">PlayersListSkeleton</code> -
                    Players list with filters and table
                  </li>
                  <li>
                    <code className="text-xs">PlayerDetailSkeleton</code> -
                    Player detail page layout
                  </li>
                  <li>
                    <code className="text-xs">TeamsListSkeleton</code> - Teams
                    page with card grid
                  </li>
                  <li>
                    <code className="text-xs">ScoutingReportsSkeleton</code> -
                    Scouting reports page
                  </li>
                  <li>
                    <code className="text-xs">GenericPageSkeleton</code> -
                    Flexible for cards, lists, or tables
                  </li>
                </ul>
              </div>
            </div>
...
<GenericPageSkeleton contentType="list" itemCount={8} />`}
              ...
              <Alert>
                ...
                <AlertDescription>
                  <ul className="list-disc list-inside space-y-1 text-sm mt-2">
                    <li>
                      Use page-specific skeletons for full-page loading states
                    </li>
                    <li>
                      Use base skeleton components for partial updates or small
                      sections
                    </li>
                    <li>
                      Match skeleton structure to actual content for zero layout
                      shift
                    </li>
                    <li>
                      Keep spinners for small inline loading states (buttons,
                      modals)
                    </li>
        ...
        <div className="text-center py-8">
          <p className="text-muted-foreground">
            Pines UI provides beautiful, accessible components built with
